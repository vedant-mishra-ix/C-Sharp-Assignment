        ...
        static void Main(string[] args)
        {
         ...
         // jab hum string array ke sath clear() ka use krte hai to default value set nai hoti hai
            ...
            */
            ...
            //funStore.Display(arrayList);----------  Method through access data-------------------------------------------

            Console.WriteLine("\nRetrive Data Funtion Through:");

            foreach(string storeList in funStore.DisplayData(arrayList))
            {
                Console.WriteLine(storeList);
            }

            Console.WriteLine("\nSort Data Funtion Through:");

            foreach (string storeList in funStore.SortData(arrayList))
            {
                Console.WriteLine(storeList);
            }
         ...
         //   arrayHashTable.Clear();                // it's remove all elemnts
           ...
           */
            ...
            */
            ...
            Store.DisplayList(arrayList);
            Store.SortList(arrayList);
            ...
            */
            ...
            funStore.DisplaySortedList(arraySortedList);
            funStore.SortSortedList(arraySortedList);
            ...
            */
            ...
            arrayDictionary.Add(1,"vegeta");
            arrayDictionary.Add(2, "goku");
            arrayDictionary.Add(3, "gohan");
            arrayDictionary.Add(4, "trunks");
            arrayDictionary.Add(5, "vegito");
            arrayDictionary.Add(6, "gogita");
            arrayDictionary.Add(7, "gogita");

            Console.WriteLine("After using Dictionary.Add() method:\n");
            foreach(KeyValuePair<int,string> store in arrayDictionary)
            {
                Console.WriteLine(store);
            }

            Console.WriteLine("After using Dictionary.Removing() method:\n");

            arrayDictionary.Remove(2);                              // remove value on the basis of key
            ...
            Console.WriteLine("After using Dictionary.Count() method:  "+ arrayDictionary.Count);   // To get total number of element

            Console.WriteLine("After using Dictionary.Values method:\n");


            foreach (KeyValuePair<int, string> store in arrayDictionary)
            {
                Console.WriteLine(store.Key +":"+ store.Value);                            // To get all values
            }


            Console.WriteLine("After using Dictionary.ContainsKey Method:  "+ arrayDictionary.ContainsKey(3));  // if key matched then it's return true  value
                                                                                                                // otherwise return false

            Console.WriteLine("After using Dictionary.ContainsKey Method:  " + arrayDictionary.ContainsValue("vegeta"));  // if key matched then it's return true  value
                                                                                                                          // otherwise return false

            Console.WriteLine("After using Dictionary.ContainsKey Method:  " + arrayDictionary.TryAdd(2,"vedant"));  
            // if you want to value on the basis of key so we can do and return true value (tabhi value add hogi jab hum koi value remove kr chuke
            // honge  or ussi position mai value add hogi key same nai honi chaiye)
            // it does not throw error at compile time or runtime error
            // we can not perform this thing through Add() method through it's give error at compile time
            ...
            Console.WriteLine("After using Dictionary.GetValueOrDefault Method:  " + arrayDictionary.GetValueOrDefault(0));
            // it's through we can get specific value on the basis of  key

            Console.WriteLine("After using Dictionary.GetHashCode Method:  " + arrayDictionary.GetHashCode());


            */

            //************************************** Store class object data in List<> *************************************

            /*

            Method personal = new Method();
            Method personal1 = new Method() { id = 2, name = "veda", email = "ved@gmail.com", mobile = 1234 };
            List<Method> StoreObj = new List<Method>();

            StoreObj.Add(personal);
            StoreObj.Add(personal1);
            //  StoreObj.RemoveAt(1);   // it's remove the data on the bais of key (it's remove the all data at index 1)
            //  StoreObj.Remove(personal1.id);

            // StoreObj.Reverse();         //it's reverse the element 

            Method[] copyObj = new Method[StoreObj.Count];  // here i made clas based array for storing previous array value

            StoreObj.CopyTo(copyObj);                       // here we are copying value to another object array


            Console.WriteLine("capacity check:  "+StoreObj.Capacity);  // id , name , email , mobile (4)


            Console.WriteLine("copy type check:  " + copyObj.GetType());

            //------------------------------------------------------- Second way -------------------------------------------------- 

            //Console.WriteLine("\nAnother way add class object data");
            //Method.GetProfileData();

            //foreach(Method storeData in Method.GetProfileData())
            //{
            //    Console.WriteLine(storeData);
            //}

            // ----------------------------------------------------- Third way ------------------------------------------------------
            Console.WriteLine("Static method through retrive class data\n");
            Method.GetProfileData();


            // ----------------------------------------------------------------------------------------------------------------------

            Console.WriteLine("After storing class object value in List<>:");
             foreach(Method store in StoreObj)
            {
            ...
            {
                Console.WriteLine(StoreObj[i].name);
            }

            Console.WriteLine("After copy value through Object\n");


            foreach (Method store in copyObj)
            {
                Console.WriteLine(store.id + "  " + store.name);
            }

            // ----------------------------------  Add Record through method ----------------------------------------
            ...
            for(int i = 0; i < key.Length ; i++)
            {
                ...
                personal.AddRecord(key[i],value[i]);
                
            }

            Console.WriteLine("\nAfter Adding value :\n");

            personal.RetriveRecord();
           ...
           */
            ...
            Stack<string> arraytack = new Stack<string>();

            arraytack.Push("vegeta");
            arraytack.Push("vegito"); 
            arraytack.Push("goku");
            arraytack.Push("gohan");
            arraytack.Push("");
            arraytack.Push("goku");

            Console.WriteLine("After using Push() method:\n");

            foreach(string storestack in arraytack)
            {
                Console.WriteLine(storestack+"\n");
            }

            
            Console.WriteLine(arraytack.Contains(""));          // if value exist then it's return true
            Console.WriteLine(arraytack.Peek());                // it's retrive top of the value 

            Console.WriteLine(arraytack.Equals(arraytack));                // it's return true value if object contain same values
            ...
            */
            ...
            foreach(int storequeue in arrayQueue)
            {
                Console.WriteLine(storequeue + "\n");
            }
            ...
            Console.WriteLine("After using Contains() Method:  "+arrayQueue.Contains(0));
            Console.WriteLine("After using Peek() Method   "+ arrayQueue.Peek());
